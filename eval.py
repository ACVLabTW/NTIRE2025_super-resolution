...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_folder", type=str, default="/work/u1657859/ming0531/NTIRE2025_ImageSR_x4/results/25_HAT/valid/")
    parser.add_argument("--target_folder", type=str, default="/work/u1657859/ming0531/NTIRE2025_ImageSR_x4/data/DIV2K_valid_HR")
